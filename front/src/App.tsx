...
import InsightsAndRecommendations from "./pages/personalActivity/InsightsAndRecommendations.tsx";
import ProfilePage from "./pages/profile/ProfilePage.tsx";
import FriendProfilePage from "./pages/friend/FriendProfilePage.tsx";
...
const routes: RouteObject[] = [
	{
		...
		children: [
			...
			{ path: "insights", element: <InsightsAndRecommendations /> },
			{ path: "profile", element: <ProfilePage /> },
			{ path: "profile/:id", element: <FriendProfilePage /> },
